...
var file_identity_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x22, 0x2a, 0x0a, 0x10, 0x47, 0x65,
	...
	,
	...
	0x12, 0x1a, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x2e, 0x56, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x52, 0x65, 0x71, 0x1a, 0x1b, 0x2e, 0x74,
	0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x2e, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x65,
...
var file_identity_proto_goTypes = []interface{}{
	(*GenerateTokenReq)(nil),  // 0: template.GenerateTokenReq
	(*GenerateTokenResp)(nil), // 1: template.GenerateTokenResp
	(*ClearTokenReq)(nil),     // 2: template.ClearTokenReq
	(*ClearTokenResp)(nil),    // 3: template.ClearTokenResp
	(*ValidateTokenReq)(nil),  // 4: template.ValidateTokenReq
	(*ValidateTokenResp)(nil), // 5: template.ValidateTokenResp
}
var file_identity_proto_depIdxs = []int32{
	0, // 0: template.identity.generateToken:input_type -> template.GenerateTokenReq
	2, // 1: template.identity.clearToken:input_type -> template.ClearTokenReq
	4, // 2: template.identity.validateToken:input_type -> template.ValidateTokenReq
	1, // 3: template.identity.generateToken:output_type -> template.GenerateTokenResp
	3, // 4: template.identity.clearToken:output_type -> template.ClearTokenResp
	5, // 5: template.identity.validateToken:output_type -> template.ValidateTokenResp
...
func (c *identityClient) GenerateToken(ctx context.Context, in *GenerateTokenReq, opts ...grpc.CallOption) (*GenerateTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/template.identity/generateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityClient) ClearToken(ctx context.Context, in *ClearTokenReq, opts ...grpc.CallOption) (*ClearTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/template.identity/clearToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *identityClient) ValidateToken(ctx context.Context, in *ValidateTokenReq, opts ...grpc.CallOption) (*ValidateTokenResp, error) {
	...
	err := c.cc.Invoke(ctx, "/template.identity/validateToken", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Identity_GenerateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/template.identity/GenerateToken",
	}
...
func _Identity_ClearToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/template.identity/ClearToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Identity_ValidateToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/template.identity/ValidateToken",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
